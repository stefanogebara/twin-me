...
export const SCENARIOS = [
  ...
  { id: 'software-table', kind: 'ask', message: 'me crie uma tabela com os gastos de software com o mais caro pra baixo', route: 'model', figures: { some: ['shares'] }, actions: { none: true }, mention: [/(\d+,\d{2}\s?(EUR|€)[\s\S]*){3}/], avoid: [/n[aã]o (posso|consigo) (fazer|criar) (uma )?tabela|cannot (make|create) a table|n[aã]o consegue responder/i], judge: false, maxSentences: 4 },
