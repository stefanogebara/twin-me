...
const LIMIT = 250;
/* The three that were already over the line when the page was split. Each may only shrink;
   a new one may not appear. Splitting them is M2-2b in docs/roadmap/PROGRESS.md. */
const STILL_LONG = { 'MoneyChatPage.tsx:MoneyConversation': 325, 'MoneySetupPage.tsx:MoneySetupPage': 409, 'readingWords.ts:readingWords': 375 };
