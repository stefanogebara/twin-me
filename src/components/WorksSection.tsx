    ...
    <section id="works" className="min-h-screen bg-card py-32 px-6">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <div className="w-20 h-20 mx-auto mb-8 bg-gradient-to-br from-stone-500 to-red-500 rounded-2xl flex items-center justify-center shadow-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          ...
          {/* Poster Style Card */}
          <div className="aspect-[3/4] bg-gradient-to-br from-red-500 to-stone-400 rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 relative overflow-hidden">
        ...
        <div className="flex justify-center items-center space-x-8 mb-12">
          ...
          <div className="w-12 h-12 bg-stone-500 rounded-full shadow-lg"></div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          ...
          <div className="aspect-square bg-gradient-to-br from-stone-400 to-pink-400 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2"></div>
