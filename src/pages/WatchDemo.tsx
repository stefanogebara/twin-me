  ...
  return (
    <div className="min-h-screen" >
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 px-6 py-6"
           style={{ backgroundColor: "hsl(var(--background))", borderBottom: '1px solid rgba(20,20,19,0.1)' }}>
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-8">
            <div className="text-2xl" style={{ fontFamily: 'var(--_typography---font--styrene-a)', fontWeight: 500, letterSpacing: '-0.02em', color: "hsl(var(--foreground))" }}>
              Twin Me
            </div>
            <div className="hidden md:flex items-center gap-6">
              <button
                ...
                style={{ fontFamily: 'var(--_typography---font--tiempos)', color: "hsl(var(--foreground))" }}
              >
                Home
              </button>
            </div>
      ...
      <section className="pt-32 pb-16 px-6">
        <div className="max-w-6xl mx-auto text-center">
          <div className="mb-12">
            <h1 className="text-5xl md:text-6xl mb-6" style={{ fontFamily: 'var(--_typography---font--styrene-a)', fontWeight: 500, letterSpacing: '-0.02em', color: "hsl(var(--foreground))" }}>
              Your Soul Signature in Action
            </h1>
            <p className="text-lg max-w-3xl mx-auto" style={{ fontFamily: 'var(--_typography---font--tiempos)', color: "hsl(var(--muted-foreground))" }}>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="bg-card rounded-2xl border p-4 shadow-sm" style={{ borderColor: "hsl(var(--border))" }}>
      ...
      <section className="py-24 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 bg-card border rounded-full px-4 py-2 mb-4" style={{ borderColor: "hsl(var(--border))" }}>
              <span className="text-sm font-medium" style={{ fontFamily: 'var(--_typography---font--tiempos)', color: '#D97706' }}>
                Soul Signature Demo
              </span>
            </div>
            <h2 className="text-4xl md:text-5xl mb-6" style={{ fontFamily: 'var(--_typography---font--styrene-a)', fontWeight: 500, letterSpacing: '-0.02em', color: "hsl(var(--foreground))" }}>
              Discover Your Authentic Self
            </h2>
            <p className="text-lg max-w-2xl mx-auto" style={{ fontFamily: 'var(--_typography---font--tiempos)', color: "hsl(var(--muted-foreground))" }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-card rounded-2xl p-8 shadow-sm border"
              ...
              <h3 className="text-xl mb-4" style={{ fontFamily: 'var(--_typography---font--styrene-a)', fontWeight: 500, letterSpacing: '-0.02em', color: "hsl(var(--foreground))" }}>
                Personal Soul Extraction
              </h3>
              <p className="leading-relaxed" style={{ fontFamily: 'var(--_typography---font--tiempos)', color: "hsl(var(--muted-foreground))" }}>
