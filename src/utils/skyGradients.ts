...
const DARK_ANCHORS: Anchor[] = [
  {
    // Deep night — warm amber/copper glow (not blue/purple)
    elevation: -30,
    am: [[180, 120, 50, 0.28], [150, 95, 45, 0.22], [140, 85, 45, 0.26], [55, 45, 100, 0.14]],
    pm: [[180, 120, 50, 0.28], [150, 95, 45, 0.22], [140, 85, 45, 0.26], [55, 45, 100, 0.14]],
  },
  {
    // Astronomical twilight — warm copper with subtle violet accent
    elevation: -12,
    am: [[190, 110, 55, 0.34], [160, 90, 50, 0.28], [150, 80, 55, 0.32], [70, 50, 110, 0.18]],
    pm: [[200, 105, 50, 0.34], [170, 85, 50, 0.28], [160, 75, 55, 0.32], [80, 50, 115, 0.18]],
  },
  {
