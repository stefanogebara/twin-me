...
export const SCENARIOS = [
  ...
  { id: 'sunday-morning', kind: 'ask', message: 'How much did I spend on Sunday morning?', route: 'model', figures: { only: ['week', 'shares', 'history'] }, actions: { none: true }, mention: [/\d+,\d{2}\s?(EUR|€)|nothing|nada|no payments|nenhum pagamento|ning[uú]n pago/i, /morning|manh[aã]|ma[nñ]ana|06:00|6h/i], avoid: [/\bgastaste\b|\bel domingo\b/i], maxSentences: 3 },
