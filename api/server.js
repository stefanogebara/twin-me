...
import observationsMeetingRoutes from './routes/observations-meeting.js';
...
import meetingBriefingsRoutes from './routes/meeting-briefings.js';
...
app.use('/api/portrait', portraitRoutes); // The Portrait: readings with receipts, verdicts, today's question (spec 2026-09-03)
