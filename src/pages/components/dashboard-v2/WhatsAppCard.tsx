...
export function WhatsAppCard() {
  ...
  return (
    <section className="mb-6">
      <div className="claura-glass relative rounded-[20px] px-5 py-4">
        <button
          onClick={dismiss}
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              style={{
                ...
                border: wa.error ? '1px solid color-mix(in srgb, var(--destructive) 50%, transparent)' : '1px solid var(--border)',
        ...
        {wa.error && (
          <p className="text-[11px] mt-2" style={{ color: 'color-mix(in srgb, var(--destructive) 80%, transparent)' }}>{wa.error}</p>
        )}
        {wa.step === 'code' && (
          <button
