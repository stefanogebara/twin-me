...
export const SCENARIOS = [
  ...
  { id: 'weekend-before', kind: 'ask', message: 'and the weekend before?', route: 'model', history: [{ role: 'user', text: 'What did last weekend cost?' }, { role: 'twin', text: 'Fim de semana passado (12 e 13 de setembro): 122,09 € em 7 pagamentos.' }], figures: { only: ['week', 'shares', 'history'] }, actions: { none: true }, mention: [/\d+,\d{2}\s?(EUR|€)|nothing|nada/i], avoid: [/122,09/], maxSentences: 3 },
  ...
  { id: 'sunday-morning', kind: 'ask', message: 'How much did I spend on Sunday morning?', route: 'model', figures: { only: ['week', 'shares', 'history'] }, actions: { none: true }, mention: [/\d+,\d{2}\s?(EUR|€)|nothing|nada/i, /morning|manh[aã]|ma[nñ]ana|06:00|6h/i], avoid: [/\bgastaste\b|\bel domingo\b/i], maxSentences: 3 },
  ...
  { id: 'meant-last-month', kind: 'ask', message: 'no, I meant last month', route: 'model', history: [{ role: 'user', text: 'How much did I spend on food?' }, { role: 'twin', text: 'Este m\u00eas voc\u00ea gastou 335,06 \u20ac em comida.' }], figures: { only: ['shares', 'months', 'history'] }, actions: { none: true }, mention: [/\d+,\d{2}\s?(EUR|€)/, /august|agosto/i], avoid: [/335,06/], maxSentences: 3 },
  ...
  { id: 'software-every-month', kind: 'ask', message: 'software. outra coisa quero saber quanto sao gastos em software todo mes', route: 'model', history: [{ role: 'user', text: '180 euros do plano do claude max tambem caem todo mes mas na conta de credito, igual a do openai que caiu' }, { role: 'twin', text: 'Entendi, voc\u00ea tem uma despesa recorrente de 180 \u20ac do plano Claude Max que cai na conta de cr\u00e9dito todo m\u00eas. O livro ainda n\u00e3o viu essa cobran\u00e7a.' }], figures: { only: ['months', 'shares', 'history', 'recurring'] }, actions: { none: true }, mention: [/\d+,\d{2}\s?(EUR|€)/, /software/i], avoid: [/n[aã]o consegue responder|cannot answer/i], maxSentences: 4 },
  { id: 'software-table', kind: 'ask', message: 'me crie uma tabela com os gastos de software com o mais caro pra baixo', route: 'model', figures: { some: ['shares'] }, actions: { none: true }, mention: [/\d+,\d{2}\s?(EUR|€)/], avoid: [/n[aã]o (posso|consigo) (fazer|criar) (uma )?tabela|cannot (make|create) a table|n[aã]o consegue responder/i], judge: false, maxSentences: 4 },
