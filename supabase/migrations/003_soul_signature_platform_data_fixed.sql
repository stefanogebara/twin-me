...
-- FIXED VERSION: All INDEX declarations moved to separate CREATE INDEX statements
...
CREATE INDEX IF NOT EXISTS idx_spotify_user_time ON spotify_listening_data (user_id, played_at DESC);
CREATE INDEX IF NOT EXISTS idx_spotify_artist ON spotify_listening_data (artist_name);
CREATE INDEX IF NOT EXISTS idx_spotify_track ON spotify_listening_data (track_id);
...
CREATE INDEX IF NOT EXISTS idx_youtube_subs_user ON youtube_subscriptions (user_id);
CREATE INDEX IF NOT EXISTS idx_youtube_channel ON youtube_subscriptions (channel_id);
...
CREATE INDEX IF NOT EXISTS idx_youtube_activity_user_time ON youtube_activity (user_id, activity_timestamp DESC);
CREATE INDEX IF NOT EXISTS idx_youtube_activity_type ON youtube_activity (activity_type);
...
CREATE INDEX IF NOT EXISTS idx_discord_patterns_user ON discord_interaction_patterns (user_id);
...
CREATE INDEX IF NOT EXISTS idx_github_repos_user ON github_repositories (user_id);
...
CREATE INDEX IF NOT EXISTS idx_github_contrib_user_date ON github_contributions (user_id, contribution_date DESC);
...
CREATE INDEX IF NOT EXISTS idx_netflix_user_time ON netflix_viewing_history (user_id, watched_at DESC);
CREATE INDEX IF NOT EXISTS idx_netflix_genre ON netflix_viewing_history (genre);
...
CREATE INDEX IF NOT EXISTS idx_instagram_user_time ON instagram_posts (user_id, posted_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_twitter_user_time ON twitter_tweets (user_id, tweeted_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_llm_context_user_type ON llm_training_context (user_id, context_type);
CREATE INDEX IF NOT EXISTS idx_llm_context_twin ON llm_training_context (twin_id);
CREATE INDEX IF NOT EXISTS idx_llm_context_confidence ON llm_training_context (confidence_score DESC);
...
CREATE INDEX IF NOT EXISTS idx_seeds_twin ON llm_conversation_seeds (twin_id);
CREATE INDEX IF NOT EXISTS idx_seeds_quality ON llm_conversation_seeds (quality_score DESC) WHERE was_user_approved;
...
CREATE INDEX IF NOT EXISTS idx_extraction_status_user ON extraction_status (user_id);
CREATE INDEX IF NOT EXISTS idx_extraction_status_due ON extraction_status (next_extraction_scheduled) WHERE extraction_stage = 'ongoing_sync';
