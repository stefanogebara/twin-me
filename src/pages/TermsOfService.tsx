  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: 'var(--background)', color: 'var(--foreground)' }}>
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <h1 className="text-3xl mb-2" style={{ fontFamily: "'Instrument Serif', Georgia, serif", fontWeight: 400 }}>
          Terms of Service
        </h1>
        ...
        <div className="space-y-8 text-sm leading-relaxed" style={{ fontFamily: "'Inter', sans-serif" }}>
          <section>
            <h2 className="text-lg mb-3" style={{ fontFamily: "'Instrument Serif', Georgia, serif", fontWeight: 400 }}>1. Acceptance of Terms</h2>
          ...
          <section>
            <h2 className="text-lg mb-3" style={{ fontFamily: "'Instrument Serif', Georgia, serif", fontWeight: 400 }}>2. Description of Service</h2>
            <p style={{ color: 'var(--foreground)' }}>
          ...
          <section>
            <h2 className="text-lg mb-3" style={{ fontFamily: "'Instrument Serif', Georgia, serif", fontWeight: 400 }}>3. Account Registration</h2>
            <p style={{ color: 'var(--foreground)' }}>
          ...
          <section>
            <h2 className="text-lg mb-3" style={{ fontFamily: "'Instrument Serif', Georgia, serif", fontWeight: 400 }}>4. User Data & Platform Connections</h2>
          ...
          <section>
            <h2 className="text-lg mb-3" style={{ fontFamily: "'Instrument Serif', Georgia, serif", fontWeight: 400 }}>5. Acceptable Use</h2>
          ...
          <section>
            <h2 className="text-lg mb-3" style={{ fontFamily: "'Instrument Serif', Georgia, serif", fontWeight: 400 }}>6. AI-Generated Content</h2>
            <p style={{ color: 'var(--foreground)' }}>
          ...
          <section>
            <h2 className="text-lg mb-3" style={{ fontFamily: "'Instrument Serif', Georgia, serif", fontWeight: 400 }}>7. Intellectual Property</h2>
            <p style={{ color: 'var(--foreground)' }}>
          ...
          <section>
            <h2 className="text-lg mb-3" style={{ fontFamily: "'Instrument Serif', Georgia, serif", fontWeight: 400 }}>8. Privacy</h2>
            <p style={{ color: 'var(--foreground)' }}>
          ...
          <section>
            <h2 className="text-lg mb-3" style={{ fontFamily: "'Instrument Serif', Georgia, serif", fontWeight: 400 }}>9. Account Termination</h2>
            <p style={{ color: 'var(--foreground)' }}>
          ...
          <section>
            <h2 className="text-lg mb-3" style={{ fontFamily: "'Instrument Serif', Georgia, serif", fontWeight: 400 }}>10. Disclaimers</h2>
            <p style={{ color: 'var(--foreground)' }}>
          ...
          <section>
            <h2 className="text-lg mb-3" style={{ fontFamily: "'Instrument Serif', Georgia, serif", fontWeight: 400 }}>11. Limitation of Liability</h2>
            <p style={{ color: 'var(--foreground)' }}>
          ...
          <section>
            <h2 className="text-lg mb-3" style={{ fontFamily: "'Instrument Serif', Georgia, serif", fontWeight: 400 }}>12. Changes to Terms</h2>
            <p style={{ color: 'var(--foreground)' }}>
