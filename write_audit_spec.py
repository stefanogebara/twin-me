"""Script to write the audit spec file."""
import os

# Output path
OUT = r"C:\Users\stefa\twin-ai-learn\tests\e2e\prod-audit-2026-04-19.spec.ts"

content = r"""import { test, expect, Page, ConsoleMessage } from "@playwright/test";
