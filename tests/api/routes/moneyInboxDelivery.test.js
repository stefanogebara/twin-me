...
vi.mock('../../../api/services/money/inbox.js', () => ({
  ...
  fetchReceivedAttachment: vi.fn(), HELD_STATEMENT_KIND: 'statement_mail', listForwardingRequests: vi.fn(async () => []), listHeldStatements: vi.fn(async () => []),
}));
