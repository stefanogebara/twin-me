/**
 * The orb engine: dotted thought-orbs for the moments the ledger is working.
 * =========================================================================
 ...
 *
 * This file is a copy of src/lib/orb/engine.js (the web's); the two must be re-copied together.
 */
/* eslint-disable */
...
function rt(n, s, t, r = 0.3) {
  for (const a of s) {
    ...
    n.fillStyle = inkAt(n, M, o), n.beginPath(), n.arc(a.x, a.y, a.r, 0, Math.PI * 2), n.fill();
  }
}
function it(n, s, t) {
  for (const r of s) {
    const a = r.a ?? 1, o = Math.min(1, Math.max(0, r.white)), c = Math.round((t ? 1 - o : o) * 255);
    n.strokeStyle = inkAt(n, c, a), n.lineWidth = r.w, n.beginPath(), n.moveTo(r.x1, r.y1), n.lineTo(r.x2, r.y2), n.stroke();
  }
}
