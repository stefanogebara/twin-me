 ...
 * DEPRECATED (insecure): links a phone WITHOUT proving ownership — a caller can
 * claim a number they do not control. Retained only so the current frontend
 * keeps working while WhatsApp is dormant. GO-LIVE CHECKLIST: before enabling a
 * WhatsApp provider, migrate the UI to /link/request + /link/verify and DELETE
 * this handler.
 */
