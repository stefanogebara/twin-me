...
export const BENCH = [
  ...
  { id: 'fn-biggest', dim: 'figure-no', message: 'What was my biggest payment this month?', route: 'model', figures: NONE, actions: NO_ACT, mention: [EUR], maxSentences: 3 },
  ...
  { id: 'gr-average', dim: 'grounding', message: 'What is my average spend per day this month?', route: 'model', figures: NONE, actions: NO_ACT, mention: [EUR, /day|dia|día/i], maxSentences: 3 },
  ...
  { id: 'gr-percent', dim: 'grounding', message: 'What percentage of my spending this month is software?', route: 'model', figures: { only: ['shares'] }, actions: NO_ACT, mention: [/\d+\s?%|percent|por ciento/i, /software/i], maxSentences: 3 },
  ...
  { id: 'gr-net', dim: 'grounding', message: 'Am I spending more than I receive this month?', route: 'model', figures: { only: ['months', 'band'] }, actions: NO_ACT, mention: [TWO], avoid: [/1402,33/], maxSentences: 4 },
  { id: 'gr-three-months', dim: 'grounding', message: 'total spent over the last three months?', route: 'model', figures: { only: ['months'] }, actions: NO_ACT, mention: [EUR], avoid: [/2511,14|1179,15/], maxSentences: 4 },
  ...
  { id: 'fu-per-week', dim: 'follow-up', message: 'and per week?', history: [{ role: 'user', text: 'How does this month compare with the last ones?' }, { role: 'twin', text: 'Sep is at 1630,13 EUR so far. Aug closed at 582,87 EUR.' }], route: 'model', figures: { some: ['week', 'weekdays'] }, actions: NO_ACT, mention: [EUR], maxSentences: 4 },
  ...
  { id: 'co-refund', dim: 'correction', message: 'Zara refunded me 39,95 today', route: 'any', figures: { only: ['band'] }, actions: { optional: true, some: ['fact', 'remember'] }, mention: [/zara|refund|39,95/i], maxSentences: 3 },
  ...
  { id: 'ed-help', dim: 'edge', message: 'what can you do?', route: 'any', figures: NONE, actions: NO_ACT, mention: [/spend|month|comes back|ask|money/i], judge: false, maxSentences: 3 },
  ...
  { id: 're-why-high', dim: 'reasoning', stream: true, message: 'why is this month so much higher than August?', route: 'model', figures: { only: ['shares', 'months', 'weekdays', 'week', 'history'] }, actions: NO_ACT, mention: [EUR], maxSentences: 4 },
  { id: 're-afford', dim: 'reasoning', stream: true, message: 'can I afford a 60 euro dinner tonight and still be fine until the 1st?', route: 'model', figures: { only: ['band'] }, actions: NO_ACT, mention: [EUR], maxSentences: 4 },
  { id: 're-cut', dim: 'reasoning', stream: true, message: 'if I had to cut 100 euros a month, where would it come from?', route: 'model', figures: { only: ['shares', 'recurring', 'months'] }, actions: NO_ACT, mention: [EUR], maxSentences: 4 },
  { id: 're-pattern', dim: 'reasoning', stream: true, message: 'what pattern do you see in my weekends?', route: 'model', figures: { only: ['weekdays', 'week', 'shares'] }, actions: NO_ACT, maxSentences: 4 },
  { id: 're-worry', dim: 'reasoning', stream: true, message: 'should I be worried about my spending?', route: 'model', figures: { only: ['band', 'months', 'shares'] }, actions: NO_ACT, mention: [EUR], maxSentences: 4 },
  { id: 're-subs', dim: 'reasoning', stream: true, message: 'which subscription is the least worth it?', route: 'model', figures: { only: ['recurring', 'history'] }, actions: NO_ACT, mention: [/higgsfield|elevenlabs|fly|render|facebook|spotify|cannot|use/i], maxSentences: 4 },
];
