...
export const OPENING_QUESTIONS = Object.freeze([
  {
    ...
    changes: 'near-home classification',
    input: 'text',
    optional: false,
  },
  {
    ...
    changes: 'commute and campus classification',
    input: 'text',
    optional: true,
  },
  {
  ...
  },
  {
    ...
    changes: 'the month-end projection',
  ...
  },
  {
    ...
    changes: 'the month has two sides',
...
export function ledgerQuestions({ transactions = [], facts = [], placeOf = () => null, now = new Date(), limit = 5 } = {}) {
  ...
  for (const [key, list] of byMerchant) {
    ...
    questions.push({
      ...
      changes: 'what the projection expects',
