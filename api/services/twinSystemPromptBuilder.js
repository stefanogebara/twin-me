/**
 * Twin System Prompt Builder
 * Extracted from twin-chat.js for reuse across chat endpoints.
 *
 * Exports:
 *  - TWIN_BASE_INSTRUCTIONS (static template string)
 *  - MAX_DYNAMIC_CONTEXT_CHARS (constant)
 *  - deduplicateByTheme(items, getText, options)
 *  - buildTwinSystemPrompt(soulSignature, platformData, personalityScores, twinSummary, proactiveInsights, userLocation)
 */
