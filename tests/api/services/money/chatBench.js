...
export const BENCH = [
  ...
  { id: 'gr-sum-months', dim: 'grounding', message: 'How much did I spend in July and August together?', route: 'short', figures: { only: ['months'] }, actions: NO_ACT, mention: [/298,14/, /582,87/, /881,01/], judge: false, maxSentences: 2 },
  ...
  { id: 'gr-future', dim: 'grounding', message: 'How much will I spend in October?', route: 'short', figures: { only: ['recurring'] }, actions: NO_ACT, mention: [/has not begun/, /so far/, EUR], judge: false, maxSentences: 3 },
  ...
  { id: 'gr-father', dim: 'grounding', message: 'How much has my father sent me?', route: 'short', figures: NONE, actions: NO_ACT, mention: [/mauad/i, EUR, /transfer/], judge: false, maxSentences: 2 },
  ...
  { id: 'co-duplicate', dim: 'correction', message: 'El Corte Ingles 101,39 appears twice, is that a duplicate?', route: 'short', figures: NONE, actions: { optional: true, some: ['not_me'] }, mention: [/101,39 . appears (once|\d+ times)/], judge: false, maxSentences: 2 },
  ...
  { id: 'ed-who-are-you', dim: 'edge', message: 'who are you?', route: 'short', speedMs: 3000, figures: NONE, actions: NO_ACT, judge: false, maxSentences: 2 },
  ...
  { id: 're-afford', dim: 'reasoning', stream: true, speedMs: 45000, message: 'can I afford a 60 euro dinner tonight and still be fine until the 1st?', route: 'model', figures: { only: ['band'] }, actions: NO_ACT, mention: [EUR], maxSentences: 5 },
  { id: 're-cut', dim: 'reasoning', stream: true, speedMs: 45000, message: 'if I had to cut 100 euros a month, where would it come from?', route: 'model', figures: { only: ['shares', 'recurring', 'months'] }, actions: NO_ACT, mention: [EUR], maxSentences: 5 },
  { id: 're-pattern', dim: 'reasoning', stream: true, speedMs: 45000, message: 'what pattern do you see in my weekends?', route: 'model', figures: { only: ['weekdays', 'week', 'shares'] }, actions: NO_ACT, maxSentences: 5 },
  { id: 're-worry', dim: 'reasoning', stream: true, speedMs: 45000, message: 'should I be worried about my spending?', route: 'model', figures: { only: ['band', 'months', 'shares'] }, actions: NO_ACT, mention: [EUR], maxSentences: 5 },
  { id: 're-subs', dim: 'reasoning', stream: true, speedMs: 45000, message: 'which subscription is the least worth it?', route: 'model', figures: { some: ['recurring', 'history'] }, actions: NO_ACT, mention: [/higgsfield|elevenlabs|fly|render|facebook|spotify|cannot|use/i], maxSentences: 5 },
];
