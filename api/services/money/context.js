...
export const OPENING_QUESTIONS = Object.freeze([
  {
    ...
    why: 'It gives your answers local context. It does not track your phone.',
    changes: 'the location context in your answers',
    input: 'place:area',
    optional: false,
  },
  {
    ...
    why: 'It gives your answers study context. Payments are not automatically labelled as a commute.',
    changes: 'the study context in your answers',
    input: 'place:name',
    optional: true,
  },
  {
    ...
    why: 'It gives your answers work context. A payment still needs your explanation to count as work.',
    changes: 'the work context in your answers',
    input: 'place:name',
    optional: true,
  },
  {
