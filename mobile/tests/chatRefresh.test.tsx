...
vi.mock('../src/services/moneyApi',()=>({moneyApi:{chatHistory:f.history,recurring:async()=>[],months:async()=>[],categories:async()=>({groups:[]}),forecast:async()=>({projected_p50:5}),ledger:async()=>[]}}));
