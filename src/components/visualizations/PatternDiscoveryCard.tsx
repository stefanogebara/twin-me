...
export function PatternDiscoveryCard({ pattern, className = '' }: PatternDiscoveryCardProps) {
  ...
  const getConfidenceColor = (confidence: number): string => {
    ...
    if (confidence >= 50) return 'text-white/60 bg-white/5 border-white/10';
      ...
      <div className="p-6">
        ...
        <div className="flex items-center justify-between">
          <button
            ...
            className="flex items-center space-x-2 text-sm text-white/60 hover:text-muted-foreground font-medium transition-colors"
          >
