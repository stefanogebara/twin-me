  ...
  return (
    <div className="min-h-screen" style={{ color: 'var(--foreground)' }}>
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <h1
          className="text-3xl mb-2" style={{ fontFamily: "var(--font-heading)", fontWeight: 400 }}
        >
          Privacy Policy
        </h1>
        ...
        <div className="space-y-8 text-sm leading-relaxed" style={{ fontFamily: "'Inter', sans-serif" }}>
          <section>
            <h2 className="text-lg mb-3" style={{ fontFamily: "var(--font-heading)", fontWeight: 400 }}>1. Introduction</h2>
          ...
          <section>
            <h2 className="text-lg mb-3" style={{ fontFamily: "var(--font-heading)", fontWeight: 400 }}>2. Data We Collect</h2>
          ...
          <section>
            <h2 className="text-lg mb-3" style={{ fontFamily: "var(--font-heading)", fontWeight: 400 }}>3. How We Use Your Data</h2>
          ...
          <section>
            <h2 className="text-lg mb-3" style={{ fontFamily: "var(--font-heading)", fontWeight: 400 }}>4. Third-Party Services</h2>
          ...
          <section>
            <h2 className="text-lg mb-3" style={{ fontFamily: "var(--font-heading)", fontWeight: 400 }}>5. Data Storage & Security</h2>
            <ul className="list-disc list-inside space-y-1 ml-2" style={{ color: 'var(--foreground)' }}>
          ...
          <section>
            <h2 className="text-lg mb-3" style={{ fontFamily: "var(--font-heading)", fontWeight: 400 }}>6. Your Rights & Controls</h2>
          ...
          <section>
            <h2 className="text-lg mb-3" style={{ fontFamily: "var(--font-heading)", fontWeight: 400 }}>7. Data Sharing</h2>
            <p style={{ color: 'var(--foreground)' }}>
          ...
          <section>
            <h2 className="text-lg mb-3" style={{ fontFamily: "var(--font-heading)", fontWeight: 400 }}>8. Data Retention</h2>
            <p className="mb-3" style={{ color: 'var(--foreground)' }}>
          ...
          <section>
            <h2 className="text-lg mb-3" style={{ fontFamily: "var(--font-heading)", fontWeight: 400 }}>9. Children's Privacy</h2>
            <p style={{ color: 'var(--foreground)' }}>
          ...
          <section>
            <h2 className="text-lg mb-3" style={{ fontFamily: "var(--font-heading)", fontWeight: 400 }}>10. Changes to This Policy</h2>
            <p style={{ color: 'var(--foreground)' }}>
          ...
          <section>
            <h2 className="text-lg mb-3" style={{ fontFamily: "var(--font-heading)", fontWeight: 400 }}>11. Contact</h2>
            <p style={{ color: 'var(--foreground)' }}>
